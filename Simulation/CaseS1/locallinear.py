...
n_vector = [100,300]#[20,200]#[] 
m_vector = [10,30]#,150,200,250,300,350m_vector = [20]#,150,200,250,300,350
...
if __name__ == '__main__': 
    for ij in range(len(ind_matrix)):  ##################################
        ...
        datapath = ["./20240425/hie/case2/data/data"  for _ in range(n_repeat)] 
        ...
        np.save("./Simulation/CaseS1/res/locallinear"+str(i)+"m"+str(j)+".npy", nnres)
        print(i,j) 
        print("is ok") 
