...
def savedata(seed):
    ...
    x_test = np.random.uniform(low=0, high=1, size=30000).reshape(-1,3)
    ...
    np.save("./Simulation/Case5/data/data"+str(seed)+".npy", a)
