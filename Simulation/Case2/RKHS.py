...
def RKHS_train(n_train, m_train, seed, datapath, lambdac_set = np.geomspace(1e-8, 1e-3, 16)):
...
if __name__ == '__main__': 
    for ij in range(len(ind_matrix)):  ##################################
        ...
        datapath = ["./Simulation/Case2/data/data"  for _ in range(n_repeat)] 
        ...
        np.save("./Simulation/Case2/res/rkhsreg"+str(i)+"m"+str(j)+".npy", nnres)
        print(i,j) 
        print("is ok") 
