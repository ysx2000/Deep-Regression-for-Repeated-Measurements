...
def local_linear_train(n_train, m_train, seed, datapath, bandwidth_set=np.geomspace(0.05, 1, 8)):
    """
...
if __name__ == '__main__': 
    for ij in range(len(ind_matrix)): 
        ...
        datapath = ["./Simulation/Case4/30d/data/data"  for _ in range(n_repeat)] 
        ...
        np.save("./Simulation/Case4/30d/res/locallinear"+str(i)+"m"+str(j)+".npy", nnres)
        print(i,j) 
        print("is ok") 
