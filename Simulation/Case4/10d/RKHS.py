...
def RKHS_train(n_train, m_train, seed, datapath, lambdac_set = np.geomspace(1e-20, 1e-4, 40)):
    """
...
if __name__ == '__main__': 
    for ij in range(len(ind_matrix)):
        ...
        datapath = ["./Simulation/Case4/10d/data/data"  for _ in range(n_repeat)] 
        ...
        np.save("./Simulation/Case4/10d/res/rkhsreg"+str(i)+"m"+str(j)+".npy", nnres)
        print(i,j) 
        print("is ok") 
